...
import TailorCard from "../update-consultants/TailorCard";
import StaffCard from "./StaffCard";
import AdminTailorCard from "../AdminTailorCard";
...
const Tabs = ({ tailors, consultants, beaders, others }) => {
  return (
